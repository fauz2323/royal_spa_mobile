...
extension ServicesStatePatterns on ServicesState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(ServiceSpaModel data)? loaded,
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ServiceSpaModel data) loaded,
...
class _Loading implements ServicesState {
  const _Loading();
...
class _Loaded implements ServicesState {
  const _Loaded(this.data);

  final ServiceSpaModel data;
  ...
  @override
  String toString() {
    return 'ServicesState.loaded(data: $data)';
  }
}
...
class _Error implements ServicesState {
...
class _Unauthorized implements ServicesState {
  const _Unauthorized();
  ...
  @override
  String toString() {
    return 'ServicesState.unauthorized()';
  }
}
