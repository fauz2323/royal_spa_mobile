...
mixin _$HomeScreenState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is HomeScreenState);
  }
...
class $HomeScreenStateCopyWith<$Res> {
  $HomeScreenStateCopyWith(
      HomeScreenState _, $Res Function(HomeScreenState) __);
}
...
class _Loading implements HomeScreenState {
  const _Loading();
...
class _Error implements HomeScreenState {
...
class _Unauthorized implements HomeScreenState {
  const _Unauthorized();
  ...
  @override
  String toString() {
    return 'HomeScreenState.unauthorized()';
  }
}
